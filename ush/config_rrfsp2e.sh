...
#
VX_FCST_INPUT_BASEDIR="/scratch2/BMC/fv3lam/HIWT/HWT-SFE_data/RRFSp2e"
FCST_SUBDIR_TEMPLATE='{init?fmt=%Y%m%d%H?shift=-${time_lag}}${SLASH_ENSMEM_SUBDIR_OR_NULL}'
FCST_FN_TEMPLATE='${NET}.t{init?fmt=%H?shift=-${time_lag}}z.bgsfcf{lead?fmt=%HHH?shift=${time_lag}}.tm00.grib2'
FCST_FN_METPROC_TEMPLATE='${NET}.t{init?fmt=%H}z.bgsfcf{lead?fmt=%HHH}.tm00_a${ACCUM}h.nc'
#
